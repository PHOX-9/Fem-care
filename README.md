...
2. Symptoms are recorded through a guided input interface  
3. Machine learning model predicts PCOS severity  
4. Results and wellness tips are displayed to the user  
5. Symptom trends are tracked and visualized over time  
6. Chatbot offers ongoing emotional and mental wellness support  
